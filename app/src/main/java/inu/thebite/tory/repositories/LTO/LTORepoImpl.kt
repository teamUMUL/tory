...
class LTORepoImpl: LTORepo {
    ...
    override suspend fun getLTOsByStudent(domainId : Long, studentId: Long): List<LtoResponse> {
        return ltoRetrofit.getLtoListByStudent(domainId = domainId, studentId = studentId)
    }
