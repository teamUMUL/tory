                    ...
                    items(STODetailTitles) { stoDetailItem ->
                        Row(
                            ...
                            val selectedSTODetail = listOf(
                                ...
                                selectedSTO.count.toString(),
                                selectedSTO.goalPercent.toString(),
                ...
                selectedEducation?.let { selectedEducation->
                    Row(
                        ...
                        Row(
                            ...
                            Text(
                                text = selectedEducation.educationResult.count { it == "+" }.toString(),
                            ...
                            Text(
                                text = selectedEducation.educationResult.count { it == "P" }.toString(),
                                modifier = Modifier.padding(horizontal = 5.dp)
                            )
                                ...
                                items(5) { horizonIndex ->
                                    ...
                                    Card(
                                        modifier = Modifier
                                            ...
                                            .fillMaxHeight(0.3f)
                                            .clickable {
                                                selectedSTODetailGameDataIndex.intValue = (5 * verticalIndex) + horizonIndex
                                            },
                                ...
                                Button(
                                    ...
                                    onClick = {
                                        ...
                                        if((selectedEducation.educationResult.count { it == "+" }.toFloat()/selectedEducation.educationResult.size.toFloat())*100 >= 90f){
                                            selectedSTO.status= "준거 도달"
                                            setSTOStatueIndex(1)
                                        }else{
                                            selectedSTO.status= "진행중"
                                            setSTOStatueIndex(0)
                    ...
                    LazyRow(
                        ...
                        items(buttonList) { buttonItem ->
                            OutlinedButton(
                                ...
                                onClick = {
                                    if(selectedSTODetailGameDataIndex.value < selectedEducation.educationResult.size){
                                        val changeList = selectedEducation.educationResult.toMutableList()

                                        when (buttonItem) {
                                            "+" -> {
                                                changeList[selectedSTODetailGameDataIndex.value] = "+"
                                            }
                                            "-" -> {
                                                changeList[selectedSTODetailGameDataIndex.value] = "-"
                                            }
                                            "P" -> {
                                                changeList[selectedSTODetailGameDataIndex.value] = "P"
                                            }
                                            else -> {
                                                changeList[selectedSTODetailGameDataIndex.value] = "n"
                                            }
                                        }
